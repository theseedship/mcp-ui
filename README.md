...
- **Multi-source scratchpad** - 14 section types, error+retry, source_card, diff comparison, asyncAction, pinned mode
...
|---------|---------|-------------|
| [`@seed-ship/mcp-ui-solid`](./mcp-ui-solid) | 2.14.0 | SolidJS components for rendering MCP-generated UI |
